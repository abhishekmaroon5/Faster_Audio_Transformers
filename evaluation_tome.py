...
label_csv = '/data/swarup_behera/Research/TOME/ToMe/egs/audioset/data/class_labels_indices.csv'       # label and indices for audioset data
...
label_csv = '/data/swarup_behera/Research/TOME/ToMe/egs/speechcommands/data/speechcommands_class_labels_indices.csv'       # label and indices for audioset data
