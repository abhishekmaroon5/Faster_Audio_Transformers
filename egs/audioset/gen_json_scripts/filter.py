...
def filter_csv(wav_folder, csv_folder):
    ...
    csv_path = os.path.join(csv_folder, 'filtered_eval_segments.csv')  # Replace with your actual CSV filename
    output_csv_path = os.path.join(csv_folder, 'new_filtered_eval_segments.csv')  # Replace with your desired output CSV filename
...
csv_folder_path = "/data/swarup_behera/Research/TOME/ToMe/egs/audioset/data/metadata/"
wav_folder_path = '/data/swarup_behera/Research/TOME/ToMe/egs/audioset/audios/eval_segments'
